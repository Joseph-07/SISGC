            ...
            <div class="relative bg-slate-200 rounded-lg shadow-3xl dark:bg-gray-100 zoom">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-emerald-700">
                    <h3 class="text-lg font-semibold text-emerald-900 ">
                        Registrar nuevo tipo de pregunta
                    </h3>
                </div>
                <div>
                    <form action="{{ route('tiposQuest.store') }}" method="POST" class="p-4">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            <div class="col-span-2">
                                <x-modal.input nombre="name" titulo="Nombre" placeholder="Escriba el nombre del tipo de pregunta"
                                    tipo="text" />
                            </div>
                            <div class="col-span-2 mt-4 flex mx-auto gap-4">
                                ...
                                <button
                                    ...
                                    <a href="{{ route('tiposQuest.index') }}" class="py-2.5 px-5">
                                        Volver
                                    </a>
                                </button>
                            </div>

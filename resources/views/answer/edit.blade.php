    ...
    <div class="bg-black bg-opacity-50 flex h-full">
        ...
        <div class="p-4 w-full  max-w-7xl mx-auto mt-24">
            ...
            <div class="relative bg-slate-200 rounded-lg shadow-3xl dark:bg-gray-100 zoom">
                ...
                @endif
                <div>
                    <form action="{{ route('respuestas.update', $answer->id) }}" method="POST" enctype="multipart/form-data"
                        class="p-4">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-4 gap-4">
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="enunce" id="enunce" cols="30" rows="1"
                                    class="resize-none bg-gray-50 border border-gray-300 text-gray-900 hover:border-emerald-900 focus:ring-emerald-800  focus:border-emerald-800 text-sm rounded-lg  block w-full p-2.5">@if (old('enunce') != null){{ old('enunce') }}@else {{ $answer->enunce }}@endif</textarea>
                            </div>
                            ...
                            @if ($question->type_quest->name != 'Linea de aprendizaje')
                                <div class="col-span-1 col-start-2">
                                    ...
                                    @else
                                        <x-modal.input type="number" nombre="value" titulo="Valor" placeholder="Escriba el valor de la respuesta" valor="{{ $answer->value }}"/>
                                    @endif
                                </div>
                                ...
                                <div class="col-span-1">
                                    ...
                                    @if (old('right') != null)
                                        ...
                                        class=" focus:ring-0 rounded-full checked:bg-emerald-800 checkbox:bg-emerald-800 appearance-none text-emerald-900 focus:text-emerald-800 checked:text-emerald-900" checked>
                                        @else
                                        <input type="checkbox" name="right" id="right"

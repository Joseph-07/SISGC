...
<div id="crud-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full  max-w-md mx-auto mt-28 max-h-lg">
        ...
        <div class="relative bg-slate-200 rounded-lg shadow-3xl dark:bg-gray-100">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('sistemas.store') }}" method="POST">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Escriba el nombre del sistema" required="">
                    </div>
                    <div class="col-span-2">
                        ...
                        <textarea id="description" rows="4"
                            ...
                            placeholder="Escriba la descripción del sistema" name="description"></textarea>
                    </div>
                </div>
                <button type="submit"

                        ...
                        <div class="grid grid-cols-2">
                            ...
                            <div class="col-span-2 mt-2">
                                ...
                                <textarea placeholder="Escriba la descripción" name="description" id="description" cols="30" rows="10"
                                    class="resize-none p-2.5 col-span-2 bg-gray-50 border border-gray-300 text-gray-900 hover:border-emerald-800 focus:ring-emerald-800  focus:border-emerald-800 text-sm rounded-lg  block w-full">{{ $syst->description }}
</textarea>
                            </div>
                            ...
                            <div class="col-span-1 mt-4">
                                <button
                                    ...
                                    <a href="{{ route('sistemas.index') }}" class="py-3 px-5">
                                        Volver
                                    </a>
                                </button>
                            </div>

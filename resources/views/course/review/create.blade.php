    ...
    <div class="bg-black bg-opacity-50 flex h-full">
        ...
        <div class="p-4 w-full  max-w-2xl mx-auto mt-24">
            ...
            <div class="relative bg-slate-200 rounded-lg shadow-3xl dark:bg-gray-100 zoom">
                ...
                @endif
                <div>
                    <form action="{{ route('cursos.reviewsStore', $id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-2 px-2">
                            <div class="col-span-2 ">
                                ...
                                <textarea name="comment" id="comment" cols="30" rows="10"
                                    class="resize-none p-2.5 col-span-2 bg-gray-50 border border-gray-300 text-gray-900 hover:border-emerald-800 focus:ring-emerald-800  focus:border-emerald-800 text-sm rounded-lg  block w-full">{{ old('comment') }}</textarea>
                            </div>

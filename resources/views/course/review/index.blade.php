...
@section('content')
    <div class="zoom" id="container">
        <div class="w-full bg-emerald-700 rounded-lg shadow-md text-white px-2 font-semibold text-sm">
            SISGC » Cursos » Administrar Cursos » Reseñas del curso
        </div>
        <h1 class="text-3xl mb-6 text-center font-bold mt-4">Reseñas del curso</h1>
        ...
        <div class="flex mt-2">
            <a href="{{ route('cursos.reviewsCreate', $id) }}" class="ml-auto mr-1 flex mt-2 zoomh bg-slate-600 hover:bg-emerald-700 text-white text-xs font-semibold p-2 rounded shadow-md ">Nuevo</a>
        ...
        <div class="container max-w-5xl mx-auto mt-6 ">
            ...
            <div class=" rounded-md bg-white shadow-xl">
                <div class=" bg-slate-200 w-full flex border-b-2 border-emerald-800 rounded-t-md shadow-3xl">
                    <span class="mx-auto text-md font-semibold text-gray-900 py-1">Lista de reseñas</span>
                </div>
                @isset($reviews)
                    <div class="bg-emerald-700 border-b-2 border-emerald-800 grid grid-cols-5 text-white font-semibold ">
                        <span class="text-center my-auto">Personal</span>
                        <span class="text-center my-auto col-span-2">Reseña</span>
                        <span class="text-center my-auto">Fecha</span>
                    ...
                    @foreach ($reviews as $review)
                        <div class="bg-slate-100 border-b-2 border-emerald-700 grid grid-cols-5 py-4">
                            ...
                            <div class="mx-auto my-auto text-center">
                                <span>{{ $review->personal->name }} {{ $review->personal->last_name }}</span>
                            </div>

                            <div class="mx-auto my-auto text-center col-span-2">
                            ...
                            <div class=" mx-auto flex">
                                <div class="zoomh">
                                    <span class="mr-1">
                                        <button class="p-2 px-0 bg-slate-600 hover:bg-emerald-700 text-white text-xs font-semibold rounded-xl ">
                                            ...
                                            <a href="{{ route('cursos.reviewsEdit', $review) }}" class="p-2 ">
                                                Editar
                                            </a>
                                        </button>
                                    </span>
                                ...
                                <div class="zoomh">
                                    <span class="ml-1">
                                        <button id="btn-delete-{{ $review->id }}"
                                ...
                                <x-confirm id="crud-modal-{{ $review->id }}" idb="close-modal-{{ $review->id }}" 
                                    direccion="{{ route('cursos.reviewsDestroy', $review) }}" />
                            </div>
                        </div>
                    @endforeach
                @endisset
